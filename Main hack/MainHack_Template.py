...
for j in np.arange(0.1,1,0.1):
    ...
    print(round(custom_prob,3),round(metrics.accuracy_score(train_labelsnn,custom_cutoff_data),4))
##0.6-0.9986 highest
...
result_nn.to_csv(r'E:\AbhinavB\Kaggle\Python related\DSBA related\Competions\practice hackathon\result_nn_3_thresh.csv',index=False)
