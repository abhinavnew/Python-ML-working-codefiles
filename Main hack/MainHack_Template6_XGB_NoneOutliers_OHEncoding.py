# -*- coding: utf-8 -*-
"""
Created on Sat Jul 31 14:00:20 2021
...
xgb_mod=GridSearchCV(estimator=xgbobj,param_grid=param_grid,cv=10,verbose=20,scoring=make_scorer(f1_score))
...
#loaded_xgb_mod_disk=pickle.load(open("xgbmod1_temp4_ulll.dat","rb"))
#print("Loaded from disk : loaded_xgb_mod_disk-from file xgbmod1_temp4_ulll.dat ")
