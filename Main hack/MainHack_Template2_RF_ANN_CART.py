# -*- coding: utf-8 -*-
"""
Created on Fri Jul 30 11:38:10 2021
...
nn_mod1 = GridSearchCV(estimator = nn_cl, param_grid = param_grid3, cv = 8,verbose=20)
...
pred_unk_nn=pd.Series(pred_unk_nn.astype(int),name="Employeeturnover")
