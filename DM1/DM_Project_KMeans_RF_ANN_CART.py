...
#bankmark.drop(['spending_scale'],axis=1,inplace=True)
...
out_minpayment=bankmark.loc[(bankmark['min_payment_amt']>ul1),]
...
##Silhoutte score 
silhouette_score(bankmark_scaled,labels)
