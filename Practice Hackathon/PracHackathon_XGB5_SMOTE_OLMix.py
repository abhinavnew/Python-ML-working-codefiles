# -*- coding: utf-8 -*-
"""
Created on Tue Jun  1 12:20:09 2021
...
##Overall 27 % Positive class-1 and 73% Negative class -0
oversample=SMOTE()
...
for label, _ in counter.items():
    row_ix = where(train_labels == label)[0]
    plt.scatter(trainset[row_ix, 0], trainset[row_ix, 1], label=str(label))
plt.legend()
plt.show()
...
# print(pred2.size)
# print(accuracy_score(pred2,all_labels))
...
#     print(round(custom_prob,3),metrics.precision_score(all_labels,custom_cutoff_data))
...
result_xgb.to_csv(r'E:\AbhinavB\Kaggle\Python related\DSBA related\Competions\practice hackathon\submission files\result_xgb_26_SMOTE_WithReg_gridsearch.csv',index=False)
