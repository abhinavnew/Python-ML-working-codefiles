# -*- coding: utf-8 -*-
"""
Created on Wed May 26 19:10:06 2021
...
emp['MonthlyIncome']=treat_outlier_1_99_winsor(emp['MonthlyIncome'])  
print("Winsorization complete for column")
...
result_xgb.to_csv(r'E:\AbhinavB\Kaggle\Python related\DSBA related\Competions\practice hackathon\submission files\result_xgb_25_WithReg_gridsearch.csv',index=False)
