# -*- coding: utf-8 -*-
"""
Created on Fri Nov 26 16:56:07 2021
...
####Missin values -KNN imputer 

capchurn.isnull().sum()


cols_to_use=['Tenure','City_Tier','CC_Contacted_LY','Payment','Gender','Service_Score','Account_user_count','account_segment','CC_Agent_Score','Marital_Status','rev_per_month'
...
knncapchurn_notarget= capchurn.drop('Churn', axis=1)
# Copy target into the y dataframe. 
knncapchurn_onlytarget = capchurn[['Churn']]



imputer.fit(knncapchurn_notarget,knncapchurn_onlytarget

print("Running KNN Imputer on entire dataset now ....")
knncapchurn_notarget_imp=imputer.transform(knncapchurn_notarget)
capchurn=pd.Series(knnlabels.astype(int),name="Employeeturnover")
